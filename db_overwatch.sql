...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-11-2018 a las 14:55:30
...
INSERT INTO `comentario` (`id`, `id_pj`, `autor`, `puntaje`, `contenido`) VALUES
(2, 9, 'admin', 1, 'asdas'),
(3, 9, 'admin', 3, 'asdas'),
(4, 9, 'admin', 5, 'asdas');
...
(9, 'Roadhog', 'Roadhog emplea su insigne garfio para atraer a los enemigos y hacerlos trizas con los disparos de su chatarrera. Es lo bastante robusto como para aguantar cantidades ingentes de daño y puede recuperar la salud con un inhalador portátil.', 6),
